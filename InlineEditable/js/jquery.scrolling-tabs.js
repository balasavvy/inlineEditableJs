  ...
  (function (p) {
      ...
      p.refreshAllElementSizes = function () {
        ...
        if (stc.scrollArrowsVisible) {
         $('body').addClass("arrow_visible");
          ehd.setFixedContainerWidthForJustVisibleScrollArrows();
        }else{
          $('body').removeClass("arrow_visible");
        }
  ...
  var tabElements = (function () {
    ...
    function getNewElScrollerElementWrappingNavTabsInstance($navTabsInstance) {
      var $tabsContainer = $('<div class="scrtabs-tab-container"></div>'),
          $leftArrow = $('<div class="scrtabs-tab-scroll-arrow scrtabs-js-tab-scroll-arrow-left"><span class="glyphicon glyphicon glyphicon-menu-left"></span></div>'),
          $rightArrow = $('<div class="scrtabs-tab-scroll-arrow scrtabs-js-tab-scroll-arrow-right"><span class="glyphicon glyphicon glyphicon-menu-right"></span></div>'),
